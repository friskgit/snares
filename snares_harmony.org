...
#+begin_src sclang :results none
  ...
  ~setRunningVariables = { |fund=1, mode=\harmony, ampMode=\default, synthMode=\snare, scaleIndex, bAmp=0.3|
...
#+begin_src sclang :results none :noweb yes
  ...
  ~setSpatPositions.value([[7, 1, 10], [9, 1, 10]], 10);
#+end_src
...
#+begin_src sclang :results none
  x = Pfunc({ |inval|
    ...
    ~updatePanningAmbiSingle.value(inval-1, az, el, 1, 20) }).asStream;
...
#+begin_src sclang :results none
  ~setSpatPositions.value([ [9, 1, 1 ] ], 1, 90);
...
Fade out.
#+begin_src sclang :results none
  ~setSpatPositions.value([ [ 1, 1, 1 ], [ 0, 1, 1 ] ], 20);
#+end_src

Bring forward in one angle
#+begin_src sclang :results none
  ~setSpatPositions.value([ [1, 0.0, 50] ], 20);
  //~controlBus[1].scope;
#+end_src

Bring up, forward.
#+begin_src sclang :results none
  ~setSpatPositions.value([ [13, 1, 10 ] ], 3);
#+end_src
...
#+begin_src sclang :results none
~setSpatPositions.value([ [ 4, 1, 10 ], [ 6, 1, 10 ] ], 20);
#+end_src
