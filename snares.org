...
*** connect multi to stereo
   ...
   |             2 |      |               |      |                   |
   | Disconnecting | port | scsynth:out2  | from | system:playback_2 |
   |             4 |      |               |      |                   |
   | Disconnecting | port | scsynth:out4  | from | system:playback_2 |
   |             6 |      |               |      |                   |
   | Disconnecting | port | scsynth:out6  | from | system:playback_2 |
   |             8 |      |               |      |                   |
   | Disconnecting | port | scsynth:out8  | from | system:playback_2 |
   |            10 |      |               |      |                   |
   | Disconnecting | port | scsynth:out10 | from | system:playback_2 |
   |            12 |      |               |      |                   |
   | Disconnecting | port | scsynth:out12 | from | system:playback_2 |
   |            14 |      |               |      |                   |
   | Disconnecting | port | scsynth:out14 | from | system:playback_2 |
   |            16 |      |               |      |                   |
   | Disconnecting | port | scsynth:out16 | from | system:playback_2 |
...
*** jack for i_dispersed_snare in 1D114, 8 channels
   ...
   | Connecting | scsynth:out3  | to | system:playback_8  |
   | Connecting | scsynth:out4  | to | system:playback_6  |
   | Connecting | scsynth:out5  | to | system:playback_10 |
   | Connecting | scsynth:out6  | to | system:playback_9  |
   | Connecting | scsynth:out7  | to | system:playback_5  |
   | Connecting | scsynth:out8  | to | system:playback_7  |
...
**** synthdef
     ...
     #+begin_src sclang :results none
       (
       ~bass_snare = SynthDef(\isnaredisp, {
	   var snd,
     ...
     #+begin_src sclang :results none
       ~ifiltsnare = Synth.new("isnaredisp", [\pulse_period, 5000]);
     #+end_src
